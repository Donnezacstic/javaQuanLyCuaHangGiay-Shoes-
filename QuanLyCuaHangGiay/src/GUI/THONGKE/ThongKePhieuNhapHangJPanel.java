 ...
 * @author admin
 */
public class ThongKePhieuNhapHangJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ThongKePhieuNhapHangJPanel
     */
    ...
    public ThongKePhieuNhapHangJPanel() {
        initComponents();
        setChart();
    ...
    private void initComponents() {
        ...
        lblPhieuNhapNgay.setForeground(new java.awt.Color(255, 255, 255));
        lblPhieuNhapNgay.setText("1213414134");
        pnlThongKe.add(lblPhieuNhapNgay, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 10, -1, -1));

        lblTongChiNgay.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblTongChiNgay.setForeground(new java.awt.Color(255, 255, 255));
        lblTongChiNgay.setText("123456");
        pnlThongKe.add(lblTongChiNgay, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 40, -1, -1));

        lblPhieuNhapTuDen.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblPhieuNhapTuDen.setForeground(new java.awt.Color(255, 255, 255));
        lblPhieuNhapTuDen.setText("123456");
        pnlThongKe.add(lblPhieuNhapTuDen, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 80, -1, -1));

        lblTongChiTuDen.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblTongChiTuDen.setForeground(new java.awt.Color(255, 255, 255));
        lblTongChiTuDen.setText("123456");
        pnlThongKe.add(lblTongChiTuDen, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 110, -1, -1));

        lblPhieuNhapNamThang.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblPhieuNhapNamThang.setForeground(new java.awt.Color(255, 255, 255));
        lblPhieuNhapNamThang.setText("123456");
        pnlThongKe.add(lblPhieuNhapNamThang, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 150, -1, -1));

        lblTongChiNamThang.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblTongChiNamThang.setForeground(new java.awt.Color(255, 255, 255));
        lblTongChiNamThang.setText("123456");
        pnlThongKe.add(lblTongChiNamThang, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 180, -1, -1));

        lblTongChiNamQuy.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblTongChiNamQuy.setForeground(new java.awt.Color(255, 255, 255));
        lblTongChiNamQuy.setText("123456");
        pnlThongKe.add(lblTongChiNamQuy, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 250, -1, -1));

        lblPhieuNhapNamQuy.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblPhieuNhapNamQuy.setForeground(new java.awt.Color(255, 255, 255));
        lblPhieuNhapNamQuy.setText("123456");
        pnlThongKe.add(lblPhieuNhapNamQuy, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 220, -1, -1));

        lblPhieuNhapNam.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblPhieuNhapNam.setForeground(new java.awt.Color(255, 255, 255));
        lblPhieuNhapNam.setText("123456");
        pnlThongKe.add(lblPhieuNhapNam, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 280, -1, -1));

        lblTongChiNam.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lblTongChiNam.setForeground(new java.awt.Color(255, 255, 255));
        lblTongChiNam.setText("123456");
        pnlThongKe.add(lblTongChiNam, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 310, -1, -1));
    ...
    private void pnlXemChiTietMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlXemChiTietMouseClicked
        ...
        this.removeAll();
        this.setLayout(new BorderLayout());
        this.add(new ChiTietThongKePhieuNhapHangJPanel());
        this.validate();
        this.repaint();
