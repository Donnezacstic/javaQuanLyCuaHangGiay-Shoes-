...
import static DataThongKe.DataThongKeSanPham.ThongKeSanPhamQuyExcel;
import static DataThongKe.DataThongKeSanPham.ThongKeSanPhamThangExcel;
 ...
 * @author admin
 */
public class ChiTietThongKeSanPhamJPanel extends javax.swing.JPanel {
    Object[] columnNames ={"Tháng","Sản phẩm bán ra"};
    Object[] columnNamesBot = {"Quý","Sản phẩm bán ra"};
    ...
    public ChiTietThongKeSanPhamJPanel() {
        initComponents();
    ...
    public static void fetchAllQuy(){
        ...
        ThongKeSanPhamQuyExcel(cbxNam.getSelectedItem().toString()).forEach(ThongKeQuy->{
    ...
    public static void fetchAllThang(){
        ...
        listTableModelThang.setRowCount(0);
            ThongKeSanPhamThangExcel(cbxNam.getSelectedItem().toString()).forEach(ThongKeThang->{
            Vector row = new Vector();
    ...
    private void initComponents() {
        ...
        pnlTblDonHangChuaXacNhan1Layout.setHorizontalGroup(
            ...
            .addGroup(pnlTblDonHangChuaXacNhan1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scpDonHang1, javax.swing.GroupLayout.DEFAULT_SIZE, 856, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        add(pnlTblDonHangChuaXacNhan1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, 880, 180));
    ...
    private void pnlXuatExcelThangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlXuatExcelThangMouseClicked
        ...
        ThongKeSanPhamThangExcel.ExportExcelFile(path, DataThongKeSanPham.ThongKeSanPhamThangExcel(cbxNam.getSelectedItem().toString()));
            SweetAlert.showSweetAlert(new JFrame(), "Hoàn tất", "Xuất dữ liệu thành công", 0);
        } catch (IOException ex) {
            Logger.getLogger(ThongKeSanPhamJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void pnlXuatExcelQuyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlXuatExcelQuyMouseClicked
           try {
            ...
            ThongKeSanPhamQuyExcel.ExportExcelFile(path, DataThongKeSanPham.ThongKeSanPhamQuyExcel(cbxNam.getSelectedItem().toString()));
            SweetAlert.showSweetAlert(new JFrame(), "Hoàn tất", "Xuất dữ liệu thành công", 0);
           } catch (IOException ex) {
            Logger.getLogger(ThongKeSanPhamJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
