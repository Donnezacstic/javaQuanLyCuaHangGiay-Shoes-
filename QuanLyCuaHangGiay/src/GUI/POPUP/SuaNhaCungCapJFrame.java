...
public class SuaNhaCungCapJFrame extends javax.swing.JFrame {
    ...
    private void edit() {
        ...
        String Error = quanlycuahanggiay.quanlycuahanggiay.NhaCungCapBUS.Validation(currentNhaCungCap);
        if (Error != null) {
            GUI.Sweet.SweetAlert.showSweetAlert(this, "Lỗi", Error, 1);
            return;
        }
        quanlycuahanggiay.quanlycuahanggiay.NhaCungCapBUS.edit(currentNhaCungCap);
