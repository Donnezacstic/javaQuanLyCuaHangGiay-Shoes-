...
public class ThemSanPhamVaoPhieuNhapJFrame extends javax.swing.JFrame {
    ...
    public static SoLuongVaDonGiaJFrame SoLuongVaDonGiaJFrame;
    SweetComboBox cbxThuongHieu;
    SweetComboBox cbxSize;
    SweetComboBox cbxMau;
    private static Object[] columnNames = {"Mã sản phẩm", "Tên sản phẩm", "Size", "Màu", ""};
    private static Object[] columnNamesBot = {"Mã sản phẩm", "Tên sản phẩm", "Size", "Màu", "Đơn giá", "Số lượng", "Tạm tính", ""};

    //Function init
    private static void setIcon() {
        for (int i = 0; i < tblSanPham.getRowCount(); i++) {
            tblSanPham.getColumnModel().getColumn(4).setCellRenderer(new changeColorOfCellTable(tblSanPham, i, 4));
        }
    }

    public static void setIconBottom() {
        for (int i = 0; i < tblSanPhamDaThem.getRowCount(); i++) {
            tblSanPhamDaThem.getColumnModel().getColumn(7).setCellRenderer(new changeColorOfCellTable(tblSanPhamDaThem, i, 7));
        }
    }
    ...
    public void ShowTable(JTable table, Object[] columnName) {
        ...
        if (DanhSachSanPham == null) {
            ...
            quanlycuahanggiay.quanlycuahanggiay.SanPhamBUS.SanPhamList.forEach(sp -> {
    ...
    public ThemSanPhamVaoPhieuNhapJFrame() {
        ((javax.swing.JFrame) SwingUtilities.getWindowAncestor(quanlycuahanggiay.quanlycuahanggiay.bg.getRootPane())).setEnabled(false);
        initComponents();
    ...
    private void getAdvancedSearch() {
        ...
        MangTiemKiemSanPham = quanlycuahanggiay.quanlycuahanggiay.ChiTietPhieuNhapBUS.advancedSearch(advancedSearch);
        search();
    }
    ...
    public static void fetchDSSPWhenRemovingCTPN(String masanpham) {
        DanhSachSanPham.add(quanlycuahanggiay.quanlycuahanggiay.SanPhamBUS.getByMaSanPham(masanpham));
    }
    ...
    private void initComponents() {
        ...
        lblDonHang1.setText("Sản phẩm vừa thêm");
        ...
        tblSanPhamDaThem.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        pnlThongTinLayout.setHorizontalGroup(
            ...
            .addGroup(pnlThongTinLayout.createSequentialGroup()
                ...
                .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(scpSanPhamDaThem, javax.swing.GroupLayout.DEFAULT_SIZE, 870, Short.MAX_VALUE)
                    .addGroup(pnlThongTinLayout.createSequentialGroup()
                        .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        pnlThongTinLayout.setVerticalGroup(
            ...
            .addGroup(pnlThongTinLayout.createSequentialGroup()
                ...
                .addComponent(lblDonHang1)
                .addGap(18, 18, 18)
                .addComponent(scpSanPhamDaThem, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        txtTimKiemTheoTenSanPham.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtTimKiemTheoTenSanPhamKeyPressed(evt);
            }
        ...
        jPanel1.add(pnlTimKiemTheoTenSanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, -1, -1));
        ...
        jPanel1.add(lblTimKiemTheoTenSanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, -1, 40));
        ...
        pnlXacNhanLayout.setVerticalGroup(
            pnlXacNhanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblXacNhan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 46, Short.MAX_VALUE)
        );

        jPanel1.add(pnlXacNhan, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 20, 170, -1));
        ...
        jPanel1.add(pnlTimKiemMaSanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 70, -1, -1));
        ...
        jPanel1.add(pnlMau, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 150, 30));
        ...
        jPanel1.add(pnlSize, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, 150, -1));
        ...
        jPanel1.add(pnlThuongHieu, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 120, 150, -1));
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        {
            SoLuongVaDonGiaJFrame = new SoLuongVaDonGiaJFrame();
            SoLuongVaDonGiaJFrame.setVisible(true);
    ...
    private void txtTimKiemTheoTenSanPhamKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemTheoTenSanPhamKeyPressed
        getAdvancedSearch();
    }//GEN-LAST:event_txtTimKiemTheoTenSanPhamKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemSanPhamVaoPhieuNhapJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemSanPhamVaoPhieuNhapJFrame().setVisible(true);
            }
        });
    }
