 ...
 * @author admin
 */
public class XemSanPhamKhuyenMaiTrongChuongTrinhKMJFrame extends javax.swing.JFrame {
    ...
    public XemSanPhamKhuyenMaiTrongChuongTrinhKMJFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemSanPhamKhuyenMaiTrongChuongTrinhKMJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
