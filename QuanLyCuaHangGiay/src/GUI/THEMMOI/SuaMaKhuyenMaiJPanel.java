...
import static GUI.KHUYENMAI.ThongTinChiTietKhuyenMaiJPanel.MaSanPhamList;
 ...
 * @author admin
 */
public class SuaMaKhuyenMaiJPanel extends javax.swing.JPanel {
    ...
    public void fetchTable(){
        ...
        for(int i=0;i<MaSanPhamList.size();i++){
            ...
            SanPham = quanlycuahanggiay.quanlycuahanggiay.SanPhamBUS.getByMaSanPham(MaSanPhamList.get(i));
    ...
    public void setData(){
        ...
        cbxMaChuongTrinhKhuyenMai.setSelectedItem(currentChiTietKhuyenMai.getMaChuongTrinhKhuyenMai());
        txtMaKhuyenMai.setText(currentChiTietKhuyenMai.getMaCode());
        txtSoLuong.setText(currentChiTietKhuyenMai.getSoLuong());
        txtGiaTriToiThieu.setText(currentChiTietKhuyenMai.getGiaTriToiThieuSuDung());
        txtGiamToiDa.setText(currentChiTietKhuyenMai.getGiaTriGiamToiDa());
        ChiTietKhuyenMai.setMaChiTietKhuyenMai(lblMaChiTietKhuyenMai.getText());
        radPhanTram.setSelected(true);
    }
    public SuaMaKhuyenMaiJPanel(boolean themsua,boolean chitietchuongtrinh) {
        initComponents();
        initEvent();
        changeTable(tblSanPham,scpSanPham);
        ShowTable(tblSanPham,columnNames);
        ...
        if(chitietchuongtrinh){
            this.option2 = chitietchuongtrinh;
        }
        scpSanPham.setVisible(false);
        lblDonHang.setVisible(false);
        pnlThemSanPham.setVisible(false);        
            ...
            public void itemStateChanged(ItemEvent ie)
                {
                    ...
                    if(ie.getStateChange()==1){
                        ...
                        txtPhanTram.setText(currentChiTietKhuyenMai.getPhanTramKhuyenMai());
                    }else
            ...
            public void itemStateChanged(ItemEvent ie)
                {
                    ...
                    if(ie.getStateChange()==1){
                        ...
                        lblDonHang.setVisible(false);
                        pnlThemSanPham.setVisible(false);
                        txtGiaTienKhuyenMai.setText(currentChiTietKhuyenMai.getGiaTienKhuyenMai());
                    }else
                        currentItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/unchecked.png")));
                        txtPhanTram.setEnabled(false);
                        txtPhanTram.setText("");
    ...
    private void initComponents() {
        ...
        jPanel1.add(radPhanTram, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, 170, -1));
