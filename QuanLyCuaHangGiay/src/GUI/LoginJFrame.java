...
public class LoginJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlLogin.setBackground(new java.awt.Color(29, 27, 28));
        ...
        txtUser.setBackground(new java.awt.Color(29, 27, 28));
        ...
        pwfPassword.setBackground(new java.awt.Color(29, 27, 28));
        ...
        pwfPassword.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 255)));
        pwfPassword.setCaretColor(new java.awt.Color(255, 255, 255));
        ...
        lblLoginButton.setBackground(new java.awt.Color(210, 48, 44));
        ...
        lblExitButton.setBackground(new java.awt.Color(29, 27, 28));
        ...
        lblError.setForeground(new java.awt.Color(29, 27, 28));
    ...
    private void lblExitButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblExitButtonMouseEntered
        lblExitButton.setBackground(Color.decode("#d2302c"));
    ...
    private void lblExitButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblExitButtonMouseExited
        lblExitButton.setBackground(new Color (29,27,28));
    ...
    private void txtUserFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUserFocusGained
        txtUser.setBorder(javax.swing.BorderFactory.createMatteBorder(0,0,1,0,java.awt.Color.decode("#d2302c")));
    }//GEN-LAST:event_txtUserFocusGained

    private void txtUserFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUserFocusLost
        txtUser.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0,Color.white));
            ...
            AccountDTO account = new AccountDTO(txtUser.getText(),pwfPassword.getText());
                if(!AccountBUS.getAuth(account)) lblError.setForeground(java.awt.Color.decode("#d2302c"));
                  ...
                  if(account.getRole().equals("admin")){
                    this.dispose();
                    new quanlycuahanggiay.quanlycuahanggiay().setVisible(true);
                  }
                  else
                  if(account.getRole().indexOf("1") < 0 || account.getRole().indexOf("1") > 10) GUI.Sweet.SweetAlert.showSweetAlert(new javax.swing.JFrame(), "Lỗi", "Tài khoản này chưa được cấp quyền.", 1);
                  else{
                  this.dispose();
                 new quanlycuahanggiay.quanlycuahanggiay().setVisible(true);
                  }
    ...
    private void pwfPasswordFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pwfPasswordFocusGained
        pwfPassword.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0,java.awt.Color.decode("#d2302c")));
    ...
    private void pwfPasswordFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pwfPasswordFocusLost
        pwfPassword.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0,Color.white));
    ...
    private void lblLoginButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLoginButtonMouseEntered
        lblLoginButton.setBackground(Color.decode("#990f02"));
    ...
    private void lblLoginButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLoginButtonMouseExited
        lblLoginButton.setBackground(Color.decode("#d2302c"));
