...
import quanlycuahanggiay.Currency;
...
public class ChiTietNhanVienJPanel extends javax.swing.JPanel {
    ...
    public static AccountDTO  currentAccount = new AccountDTO();
    ...
    lblNgayVaoLam.setText(DateTime.TimestampToDateString(currentNhanVien.getNgayVaoLam(),1));
    ...
    lblLuong.setText(currency.changeCurrency(currentNhanVien.getLuong())+"đ");
    ...
    private void initComponents() {
        ...
        lblDoiMatKhau.setText("Reset mật khẩu");
        ...
        ThemTaiKhoanJPanel.add(pnlQuayVe, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1, -1));
        ...
        ThemTaiKhoanJPanel.add(lblSua, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 50, -1, -1));
    ...
    private void lblDoiMatKhauMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDoiMatKhauMouseClicked
               if (SwingUtilities.isLeftMouseButton(evt))
                   if(GUI.Sweet.SweetAlert.showSweetOption(new javax.swing.JFrame(), "Thông báo", "Reset password cho nhân viên này?", 0)==1)
                   {
                       quanlycuahanggiay.quanlycuahanggiay.AccountBUS.resetPassword(lblMaNhanVien.getText());
                       GUI.Sweet.SweetAlert.showSweetAlert(new javax.swing.JFrame(),"Thành công", "Reset thành công", 1);
                   }
