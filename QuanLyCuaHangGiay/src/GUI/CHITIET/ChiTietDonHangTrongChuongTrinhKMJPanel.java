...
import static GUI.KHUYENMAI.ThongTinChiTietKhuyenMaiTrongChuongTrinhKMJPanel.currentDonHang;
import static GUI.KHUYENMAI.ThongTinChiTietKhuyenMaiTrongChuongTrinhKMJPanel.currentKhachHang;
import static GUI.KHUYENMAI.ThongTinChiTietKhuyenMaiTrongChuongTrinhKMJPanel.currentChiTietDonHang;
 ...
 * @author admin
 */
public class ChiTietDonHangTrongChuongTrinhKMJPanel extends javax.swing.JPanel {
    
    /**
     * Creates new form ChiTietDonHangJPanel
     */
    ...
    private static double TienTamTinh;
    ...
    public static void fetchAll(){
        ...
        quanlycuahanggiay.quanlycuahanggiay.ChiTietDonHangBUS.ChiTietDonHangList.forEach(ChiTietDonHang ->{
            ...
            row.add(ChiTietDonHang.getMaSanPham());
            row.add(ChiTietDonHang.getSoLuong());
            row.add(ChiTietDonHang.getDonGia()+"đ");
            row.add(Size);
            row.add(Mau);
    ...
    public ChiTietDonHangTrongChuongTrinhKMJPanel() {
        initComponents();
        setData();
   ...
   public void setData(){
       ...
       lblGiamGia.setText(changeCurrency(TienGiamGia)+"đ");
       lblPhiVanChuyen.setText(changeCurrency(PhiVanChuyen())+"đ");
       lblTongTien.setText(changeCurrency(Tong(TienTamTinh, TienGiamGia, PhiVanChuyen()))+"đ");
    ...
    public static String TamTinh(){
        quanlycuahanggiay.quanlycuahanggiay.ChiTietDonHangBUS.ChiTietDonHangList.forEach(ChiTietDonHang ->{
            if(currentDonHang.getMaDonHang().equals(ChiTietDonHang.getMaDonHang())){
                     double TamTinh = Integer.parseInt(ChiTietDonHang.getThanhTien());
                     TienTamTinh += TamTinh;
            }
        });
        return Double.toString(TienTamTinh);
    }
    
    public String GiamGia(String MaCode, String TamTinh){
        Double TienTamTinh = Double.parseDouble(TamTinh);
        Double GiamGia = 0.0;
        ChiTietKhuyenMaiDTO ChiTietKhuyenMaicuaMaCode = quanlycuahanggiay.quanlycuahanggiay.ChiTietKhuyenMaiBUS.getByMaCode(MaCode);
        Double GiaTriToiThieuSuDung = Double.parseDouble(ChiTietKhuyenMaicuaMaCode.getGiaTriToiThieuSuDung());
        if(TienTamTinh < GiaTriToiThieuSuDung){
            return "0";
        }
        else {
            Double PhanTramKhuyenMai = Double.parseDouble(ChiTietKhuyenMaicuaMaCode.getPhanTramKhuyenMai())/100;
            Double GiaTienKhuyenMai = Double.parseDouble(ChiTietKhuyenMaicuaMaCode.getGiaTienKhuyenMai());
            GiamGia = TienTamTinh*PhanTramKhuyenMai + GiaTienKhuyenMai;
            }
        if(GiamGia >= Double.parseDouble(ChiTietKhuyenMaicuaMaCode.getGiaTriGiamToiDa())) GiamGia=Double.parseDouble(ChiTietKhuyenMaicuaMaCode.getGiaTriGiamToiDa());
    ...
    public String Tong(String TamTinh, String GiamGia, String PhiVanChuyen){
        Double Tong = Double.parseDouble(TamTinh) - Double.parseDouble(GiamGia) + Double.parseDouble(PhiVanChuyen);
